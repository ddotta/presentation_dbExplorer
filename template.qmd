...
- Cocher la case "Cliquer pour filtrer" puis :  
    - Cliquer une fois pour appliquer le filtre sur la table
    - Cliquer deux fois pour appliquer la négation du filtre sur la table
